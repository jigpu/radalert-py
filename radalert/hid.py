...
class RadAlertHIDStatus(generic.RadAlertStatus):
    ...
    def __init__(self, bytestr: bytes) -> None:
        ...
        """
        self._data: Dict[str, Union[int, bool]] = RadAlertHIDStatus.unpack(bytestr)
...
class RadAlertHIDQuery(generic.RadAlertQuery):
    ...
    def __init__(self, bytestr: bytes) -> None:
        ...
        Create a status object from a bytes object.
        """
        self._data: Dict[str, Union[str, int, bool]] = RadAlertHIDQuery.unpack(bytestr)
        self.type: str = "query"
...
class RadAlertHID(generic.RadAlert):
    ...
    def __init__(
        self,
        status_callback: Callable[[RadAlertHIDStatus], None],
        query_callback: Callable[[RadAlertHIDQuery], None],
    ) -> None:
        self.status_callback: Callable[[RadAlertHIDStatus], None] = status_callback
        self.query_callback: Callable[[RadAlertHIDQuery], None] = query_callback
        self._hiddev = None
        self._reset()
    ...
    def connect(self, vid: int, pid: int) -> None:
        ...
        assert self._hiddev is not None
