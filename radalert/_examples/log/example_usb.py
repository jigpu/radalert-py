...
from radalert.usb import RadAlertUSB


def spin(device: RadAlertUSB) -> None:
    """
...
def find_any() -> Tuple[int, int]:
    ...
    while True:
        for d in context.getDeviceIterator():
...
def main() -> None:
    ...
    device = RadAlertUSB(backend.radalert_status_callback,
